...
function UpdateOS()
    ...
    -- Time:SetDesc(datetime.." - "..timezone.." [ " .. code .. " ]") -- (SetDesc not supported in SydeUI)
end
spawn(function()
    while true do
        UpdateOS()
...
function UpdateTime()
    ...
    -- Timmessss:SetDesc(Hour.." Hour (h) "..Minute.." Minute (m) "..Second.." Second (s) ") -- (SetDesc not supported in SydeUI)
end
spawn(function()
    while true do
        UpdateTime()
...
spawn(function()
    ...
    -- Miragecheck:SetDesc('Status: ' .. currentStatus) -- (SetDesc not supported in SydeUI)
...
spawn(function()
    ...
    while task.wait(1) do
        ...
        if currentStatus ~= previousStatus then
    -- Kitsunecheck:SetDesc('Status: ' .. currentStatus) -- (SetDesc not supported in SydeUI)
            previousStatus = currentStatus
        end
    end
end)
...
task.spawn(function()
    ...
    while task.wait(1) do
        ...
        if currentStatus ~= previousStatus then
    -- CPrehistoriccheck:SetDesc("Status: " .. currentStatus) -- (SetDesc not supported in SydeUI)
            previousStatus = currentStatus
        end
    end
end)
...
spawn(function()
    ...
    while wait(1) do
        ...
        if currentStatus ~= previousStatus then
    -- FrozenIsland:SetDesc('Status: ' .. currentStatus) -- (SetDesc not supported in SydeUI)
            previousStatus = currentStatus
        end
    end
end)
...
spawn(function()
    ...
    -- MobCakePrince:SetDesc(killStatus) -- (SetDesc not supported in SydeUI)
    end
end)
...
spawn(function()
    ...
    while wait(1) do
        ...
        if currentStatus ~= previousStatus then
    -- CheckRip:SetDesc("Status: " .. currentStatus) -- (SetDesc not supported in SydeUI)
            previousStatus = currentStatus
        end
    end
end)
...
spawn(function()
    ...
    while wait(1) do
        ...
        if currentStatus ~= previousStatus then
    -- CheckDoughKing:SetDesc("Status: " .. currentStatus) -- (SetDesc not supported in SydeUI)
            previousStatus = currentStatus
        end
    end
end)
...
spawn(function()
    ...
    while wait(1) do
        ...
        if currentStatus ~= previousStatus then
    -- EliteHunter:SetDesc("Status: " .. currentStatus .. " | Killed: " .. progress) -- (SetDesc not supported in SydeUI)
            previousStatus = currentStatus
        end
    end
end)
...
task.spawn(function()
    ...
    -- FM:SetDesc(moonStatus) -- (SetDesc not supported in SydeUI)
    end
end)
...
spawn(function()
    ...
    -- LegendarySword:SetDesc(swordStatus) -- (SetDesc not supported in SydeUI)
    end
end)
...
spawn(function()
    while wait(1) do
    -- StatusBone:SetDesc("You Have: " .. tostring(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Bones", "Check")) .. " Bones") -- (SetDesc not supported in SydeUI)
    end
end)
...
spawn(function()
  while wait(Sec) do
    pcall(function()    
    -- Process:SetDesc("Elite Procress :  " ..replicated.Remotes.CommF_:InvokeServer("EliteHunter","Progress")) -- (SetDesc not supported in SydeUI)
    end)
  end
end)
...
spawn(function()
  while wait(.2) do
    pcall(function()
      ...
      if Killed then
    -- MobKilled:SetDesc(" Killed : " ..(500 - Killed)) -- (SetDesc not supported in SydeUI)
      end
    end)
  end
end)
...
spawn(function()
  while wait(.2) do
    pcall(function()
    -- CheckingBone:SetDesc(" Bones : " ..GetM("Bones")) -- (SetDesc not supported in SydeUI)
    end)
  end
end)
...
spawn(function()
    ...
    -- TyrantStatus:SetDesc("✅") -- (SetDesc not supported in SydeUI)
            else
    -- TyrantStatus:SetDesc("❌") -- (SetDesc not supported in SydeUI)
            end
        end
...
spawn(function()  
  while wait(.2) do 
    ...
    -- CheckCDK:SetDesc(" Quest Numbers : yama quest 1") -- (SetDesc not supported in SydeUI)
    elseif QuestYama_2 == true then
    -- CheckCDK:SetDesc(" Quest Numbers : yama quest 2") -- (SetDesc not supported in SydeUI)
    elseif QuestYama_3 == true then
    -- CheckCDK:SetDesc(" Quest Numbers : yama quest 3") -- (SetDesc not supported in SydeUI)
    elseif QuestTushita_1 == true then
    -- CheckCDK:SetDesc(" Quest Numbers : tushita quest 1") -- (SetDesc not supported in SydeUI)
    elseif QuestTushita_2 == true then
    -- CheckCDK:SetDesc(" Quest Numbers : tushita quest 2") -- (SetDesc not supported in SydeUI)
    elseif QuestTushita_1 == true then
    -- CheckCDK:SetDesc(" Quest Numbers: tushita quest 2") -- (SetDesc not supported in SydeUI)
	elseif GetWP("Cursed Dual Katana") then
    -- CheckCDK:SetDesc(" Quest Numbers: CDK done!!") -- (SetDesc not supported in SydeUI)
    end 
  end
end) 
Q = Tabs.Quests:Toggle({
...
spawn(function()
  while wait(.2) do
    ...
    -- Ismirage:SetDesc(" Mirage Island : True") -- (SetDesc not supported in SydeUI)
    else
    -- Ismirage:SetDesc(" Mirage Island : False") -- (SetDesc not supported in SydeUI)
    end
  end
end)
spawn(function()
  while wait(.2) do
    pcall(function()
      ...
      moon = Getmoon()
      if moon == moon1 then
    -- FullMOOn:SetDesc("Moon : 0 / 8") -- (SetDesc not supported in SydeUI)
      elseif moon == moon2 then
    -- FullMOOn:SetDesc("Moon : 1 / 8") -- (SetDesc not supported in SydeUI)
      elseif moon == moon3 then
    -- FullMOOn:SetDesc("Moon : 2 / 8") -- (SetDesc not supported in SydeUI)
      elseif moon == moon4 then
    -- FullMOOn:SetDesc("Moon : 3 / 8 [ Next Night ]") -- (SetDesc not supported in SydeUI)
      elseif moon == moon5 then
    -- FullMOOn:SetDesc("Moon : 4 / 8 [ Full Moon ]") -- (SetDesc not supported in SydeUI)
      elseif moon == moon6 then
    -- FullMOOn:SetDesc("Moon : 5 / 8 [ Last Night ]") -- (SetDesc not supported in SydeUI)
      elseif moon == moon7 then
    -- FullMOOn:SetDesc("Moon : 6 / 8") -- (SetDesc not supported in SydeUI)
      elseif moon == moon8 then
    -- FullMOOn:SetDesc("Moon : 7 / 8") -- (SetDesc not supported in SydeUI)
      end
    end)
  end
end)
...
spawn(function()
  while wait(.2) do
    pcall(function()
    -- if Quest1 == true then CheckSoul:SetDesc(" Quest Number : Quest1") -- (SetDesc not supported in SydeUI)
    -- elseif Quest2 == true then CheckSoul:SetDesc(" Quest Number : Quest2") -- (SetDesc not supported in SydeUI)
    -- elseif Quest3 == true then CheckSoul:SetDesc(" Quest Number : Quest3") -- (SetDesc not supported in SydeUI)
    -- elseif Quest4 == true then CheckSoul:SetDesc(" Quest Number : Quest4") -- (SetDesc not supported in SydeUI)
    -- elseif GetWP("Skull Guitar") then CheckSoul:SetDesc(" Quest Number : Collect!!") -- (SetDesc not supported in SydeUI)
    -- else CheckSoul:SetDesc(" Quest Number : No Quest!!") -- (SetDesc not supported in SydeUI)
      end
    end)
  end
end)
...
spawn(function()
  pcall(function()
    while wait(.2) do
    -- CheckTier:SetDesc(" Tiers - V4  :" .." "..plr.Data.Race.C.Value) -- (SetDesc not supported in SydeUI)
    end
  end)
end)
...
spawn(function()
  while wait(.2) do
    if workspace.Map:FindFirstChild("PrehistoricIsland") or workspace._WorldOrigin.Locations:FindFirstChild("Prehistoric Island") then
    -- Check_Volcano:SetDesc(" Prehistoric Island : True") -- (SetDesc not supported in SydeUI)
    else
    -- Check_Volcano:SetDesc(" Prehistoric Island : False") -- (SetDesc not supported in SydeUI)
    end
  end
end)
...
spawn(function()
  while wait(.2) do
    ...
    -- if spycheck then SPYING:SetDesc(" Spy Leviathan  : "..tostring(spycheck)) -- (SetDesc not supported in SydeUI)
        if tostring(spycheck) == 5 then
    -- SPYING:SetDesc(" Spy Leviathan : Already Done!!") -- (SetDesc not supported in SydeUI)
        end
      end
    end)
  end
...
spawn(function()
  pcall(function()
    ...
    -- FloD:SetDesc(' Flozen Dimension : True') -- (SetDesc not supported in SydeUI)
      else
    -- FloD:SetDesc(' Flozen Dimension : False') -- (SetDesc not supported in SydeUI)
      end
    end
  end)
end)
...
spawn(function()
  while wait(.2) do
    ...
    -- Check_Kitsu:SetDesc(" Kitsune Island : True") -- (SetDesc not supported in SydeUI)
    else
    -- Check_Kitsu:SetDesc(" Kitsune Island : False") -- (SetDesc not supported in SydeUI)
    end
  end
end)
Q = Tabs.SeaEvent:Toggle({
...
spawn(function()
  while wait(.2) do
    ...
    -- RaidS:SetDesc(" Raiding Status: True") -- (SetDesc not supported in SydeUI)
      else
    -- RaidS:SetDesc(" Raiding Status: False") -- (SetDesc not supported in SydeUI)
      end      
    end)
  end
end)
