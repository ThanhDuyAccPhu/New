...
-- ============================================
-- AURA Hub - Converted to SydeUI Library
-- ============================================
...
local Tabs = {
    Info = Window:InitTab({ Title = "Info And Status" }),
    Main = Window:InitTab({ Title = "Farming" }),
    Settings = Window:InitTab({ Title = "Setting Farming" }),
    Fish = Window:InitTab({ Title = "Fishing" }),
    Quests = Window:InitTab({ Title = "Stack Farm" }),
    SeaEvent = Window:InitTab({ Title = "Sea Events" }),
    Mirage = Window:InitTab({ Title = "Mirage" }),
    Race = Window:InitTab({ Title = "Upgrade Race" }),
    Drago = Window:InitTab({ Title = "Dragon Dojo" }),
    Prehistoric = Window:InitTab({ Title = "Prehistoric" }),
    Raids = Window:InitTab({ Title = "Fruit And Raid" }),
    Travel = Window:InitTab({ Title = "Teleport" }),
    Shop = Window:InitTab({ Title = "Shopping" }),
    Misc = Window:InitTab({ Title = "Miscellaneous" })
}



Tabs.Info:Section("Information")
    Tabs.Info:Paragraph({
    Title = "Aura Hub Info",
...
Tabs.Info:Section("Status Server")

Time = Tabs.Info:Paragraph({
    Title = "Time Zone",
    Content = ""
})
function UpdateOS()
    ...
    -- pcall(function() end) --[[ Time:SetDesc(datetime.." - "..timezone.." [ " .. code .. " ]") ]]
end
spawn(function()
    while true do
        UpdateOS()
...
function UpdateTime()
    ...
    -- pcall(function() end) --[[ Timmessss:SetDesc(Hour.." Hour (h) ]] "..Minute.." Minute (m) "..Second.." Second (s) ")
end
spawn(function()
    while true do
        UpdateTime()
...
Miragecheck = Tabs.Info:Paragraph({
    Title = "Mirage Island",
    Content = "Status: "
})
...
spawn(function()
    ...
    -- pcall(function() end) --[[ Miragecheck:SetDesc('Status: ' .. currentStatus) ]]
                previousStatus = currentStatus
            end
        end
    end)
end)
Kitsunecheck = Tabs.Info:Paragraph({
...
spawn(function()
    ...
    while task.wait(1) do
        ...
        if currentStatus ~= previousStatus then
    -- pcall(function() end) --[[ Kitsunecheck:SetDesc('Status: ' .. currentStatus) ]]
            previousStatus = currentStatus
        end
    end
end)
CPrehistoriccheck = Tabs.Info:Paragraph({
...
task.spawn(function()
    ...
    while task.wait(1) do
        ...
        if currentStatus ~= previousStatus then
    -- pcall(function() end) --[[ CPrehistoriccheck:SetDesc("Status: " .. currentStatus) ]]
            previousStatus = currentStatus
        end
    end
end)
FrozenIsland = Tabs.Info:Paragraph({
...
spawn(function()
    ...
    while wait(1) do
        ...
        if currentStatus ~= previousStatus then
    -- pcall(function() end) --[[ FrozenIsland:SetDesc('Status: ' .. currentStatus) ]]
            previousStatus = currentStatus
        end
    end
end)
MobCakePrince = Tabs.Info:Paragraph({
...
spawn(function()
    ...
    -- pcall(function() end) --[[ MobCakePrince:SetDesc(killStatus) ]]
    end
end)
CheckRip = Tabs.Info:Paragraph({
    Title = "Rip Indra",
    Content = "Status: "
})
spawn(function()
    ...
    while wait(1) do
        ...
        if currentStatus ~= previousStatus then
    -- pcall(function() end) --[[ CheckRip:SetDesc("Status: " .. currentStatus) ]]
            previousStatus = currentStatus
        end
    end
end)
CheckDoughKing = Tabs.Info:Paragraph({
    Title = "Dough King",
    Content = "Status: "
})
spawn(function()
    ...
    while wait(1) do
        ...
        if currentStatus ~= previousStatus then
    -- pcall(function() end) --[[ CheckDoughKing:SetDesc("Status: " .. currentStatus) ]]
            previousStatus = currentStatus
        end
    end
end)
EliteHunter = Tabs.Info:Paragraph({
    Title = "Elite Hunter",
    Content = "Status: "
})
spawn(function()
    ...
    while wait(1) do
        ...
        if currentStatus ~= previousStatus then
    -- pcall(function() end) --[[ EliteHunter:SetDesc("Status: " .. currentStatus .. " | Killed: " .. progress) ]]
            previousStatus = currentStatus
        end
    end
end)
FM = Tabs.Info:Paragraph({
    Title = "Full Moon",
    Content = ""
})
task.spawn(function()
    ...
    -- pcall(function() end) --[[ FM:SetDesc(moonStatus) ]]
    end
end)
LegendarySword = Tabs.Info:Paragraph({
...
spawn(function()
    ...
    -- pcall(function() end) --[[ LegendarySword:SetDesc(swordStatus) ]]
    end
end)
StatusBone = Tabs.Info:Paragraph({
    Title = "Bone",
    Content = ""
})
spawn(function()
    while wait(1) do
    -- pcall(function() end) --[[ StatusBone:SetDesc("You Have: " .. tostring(game:GetService("ReplicatedStorage") ]].Remotes.CommF_:InvokeServer("Bones", "Check")) .. " Bones")
    end
end)

WeaponDropdown = Tabs.Main:Dropdown({
    Title = "Choose Weapon",
...
AttackDropdown = Tabs.Main:Dropdown({
    Title = "Choose Attack Speed",
...
Tabs.Main:Toggle({
	Title = "Fast Attack Buddha",
	Description = "",
	Value = false,	CallBack = function(v)
		getgenv().FA_Buddha = v
		pcall(function()
...
Tabs.Main:Section("Collect Chest")

ChestTW = Tabs.Main:Toggle({
...
Tabs.Main:Section("Collect Berry")

Berry = Tabs.Main:Toggle({
...
BerryH = Tabs.Main:Toggle({
Title = "Auto Collect Berry + Hop Server", 
...
Tabs.Main:Section("Farm Elite Hunter")

Process = Tabs.Main:Paragraph({
Title = "Elites Process",
Content = ""})
spawn(function()
  while wait(Sec) do
    pcall(function()    
    -- pcall(function() end) --[[ Process:SetDesc("Elite Procress :  " ..replicated.Remotes.CommF_:InvokeServer("EliteHunter","Progress") ]])
    end)
  end
end)

EliteHunter = Tabs.Main:Paragraph({
    Title = "Elite Spam",
    Content = "Status: "
})
spawn(function()
...
EliteH = Tabs.Main:Toggle({
	Title = "Auto Farm Elite + Hop Server",
...
Tabs.Main:Section("Farming Cake")
MobKilled = Tabs.Main:Paragraph({
    Title = "Cake Prince:",
    Content = ""
})
spawn(function()
  while wait(.2) do
    pcall(function()
      ...
      if Killed then
    -- pcall(function() end) --[[ MobKilled:SetDesc(" Killed : " ..(500 - Killed) ]])
      end
    end)
  end
end)
...
DoughKingFarm = Tabs.Main:Toggle({
...
HopDough = Tabs.Main:Toggle({
Title = "Auto Hop Dough King", 
...
Tabs.Main:Section("Unlocked Dungeon")

DouD = Tabs.Main:Toggle({
...
Tabs.Main:Section("Farming Bone")

CheckingBone = Tabs.Main:Paragraph({
    Title = " Bone:",
    Content = ""
})
spawn(function()
  while wait(.2) do
    pcall(function()
    -- pcall(function() end) --[[ CheckingBone:SetDesc(" Bones : " ..GetM("Bones") ]])
    end)
  end
end)
Bone = Tabs.Main:Toggle({
...
Tabs.Main:Section("Tyrant Of The Skies")

TyrantStatus = Tabs.Main:Paragraph({
    Title = "Boss Spam",
    Content = ""
})
...
spawn(function()
    ...
    -- pcall(function() end) --[[ TyrantStatus:SetDesc("✅") ]]
            else
    -- pcall(function() end) --[[ TyrantStatus:SetDesc("❌") ]]
            end
        end
...
Tabs.Main:Section("Farm Material")

Test = Tabs.Main:Dropdown({
...
-- === Dropdown Chọn Boss ===
BossDropdown = Tabs.Main:Dropdown({
    Title = "Select Boss",
    Description = "",
    Options = BossList,
    Default = nil,
...
FarmBossToggle = Tabs.Main:Toggle({
    Title = "Auto Farm Boss",
    Description = "Tự Động Đánh Boss",
    Value = false,
    CallBack = function(Value)
...
Tabs.Main:Section("Farming Mastery")
local posMastery = {"Cake","Bone"}
local Mastery_Config = Tabs.Main:Dropdown({
Title = "Choose Location Farm",
		Description = "",
		Options = posMastery,
		Value = false,
		CallBack = function(Value)
...
local MasteryFruits = Tabs.Main:Toggle({
...
local MasteryGun = Tabs.Main:Toggle({
...
local MasteryGun = Tabs.Main:Toggle({
    Title = "Auto Mastery Dragon Storm", 
...
local MasterySword = Tabs.Main:Toggle({
...
Tabs.Settings:Section("Settings / Configure")

AutoBuddhaZ = Tabs.Settings:Toggle({
    Title = "Auto Use Skill Z Buddha",
...
Initialize = Tabs.Settings:Toggle({
Title = "Fast Attack", 
...
local Bringmob = Tabs.Settings:Toggle({
Title = "Bring Mob", 
...
HopToggle = Tabs.Settings:Toggle({
    Title = "Auto Hop [Evevry 30 Minutes]",
...
RaceV3Aura = Tabs.Settings:Toggle({
...
RaceV4Aura = Tabs.Settings:Toggle({
...
RandomAround = Tabs.Settings:Toggle({
...
SafeModes = Tabs.Settings:Toggle({
Title = "Panic Mode", 
...
DisableHitVFX = Tabs.Settings:Toggle({
    Title = "Remove Hit",
...
RmvVFX = Tabs.Settings:Toggle({
Title = "Remove Death And Respamed", 
...
DisblesNotify = Tabs.Settings:Toggle({
	...
	Sliders = {
		{
			...
			Range = {26, 300},
			Increment = 1,
			StarterValue = getgenv().WalkSpeedValue,
			CallBack = 
		}
	}
})
	...
	Sliders = {
		{
			...
			Range = {50, 500},
			Increment = 1,
			StarterValue = getgenv().JumpValue,
			CallBack = 
		}
	}
})
...
Tabs.Settings:Section("Stats Upgrade")
StatusSelect = Tabs.Settings:CreateSlider({
	Title = "Slider",
	Sliders = {
		{
			Title = "Slider",
...
Tabs.Fish:Section("Fishing")


BaitDropdown = Tabs.Fish:Dropdown({
    Title = "Choose Bait",
    Description = "",
...
BuyBaitToggle = Tabs.Fish:Toggle({
    Title = "Auto Buy Bait",
...
SellFishToggle = Tabs.Fish:Toggle({
...
TravelDress = Tabs.Quests:Toggle({
...
Tabs.Quests:Section("Tushita And Yama")

Q = Tabs.Quests:Toggle({
...
Tabs.Quests:Section("Cursed Dual Katana")
CheckCDK = Tabs.Quests:Paragraph({
Title = " Number Cursed Dual Katana Quest ",
Content = "Quest Numbers :"})
spawn(function()  
  while wait(.2) do 
    if QuestYama_1 == true then 
    -- pcall(function() end) --[[ CheckCDK:SetDesc(" Quest Numbers : yama quest 1") ]]
    elseif QuestYama_2 == true then
    -- pcall(function() end) --[[ CheckCDK:SetDesc(" Quest Numbers : yama quest 2") ]]
    elseif QuestYama_3 == true then
    -- pcall(function() end) --[[ CheckCDK:SetDesc(" Quest Numbers : yama quest 3") ]]
    elseif QuestTushita_1 == true then
    -- pcall(function() end) --[[ CheckCDK:SetDesc(" Quest Numbers : tushita quest 1") ]]
    elseif QuestTushita_2 == true then
    -- pcall(function() end) --[[ CheckCDK:SetDesc(" Quest Numbers : tushita quest 2") ]]
    elseif QuestTushita_1 == true then
    -- pcall(function() end) --[[ CheckCDK:SetDesc(" Quest Numbers: tushita quest 2") ]]
	elseif GetWP("Cursed Dual Katana") then
    -- pcall(function() end) --[[ CheckCDK:SetDesc(" Quest Numbers: CDK done!!") ]]
    end 
  end
end) 
Q = Tabs.Quests:Toggle({
...
Tabs.Quests:Section("True Triple Katana Sword")
Tabs.Quests:Button({
...
Tabs.Quests:Section("Pole / God Enal's")
Q = Tabs.Quests:Toggle({
...
Tabs.Quests:Section("Items Law / Order Sword")
Q = Tabs.Quests:Toggle({
Title = "Auto Get Law Sword", 
...
Tabs.Quests:Section("East Blue Misc")
Q = Tabs.Quests:Toggle({
Title = "Auto Get Saw Sword", 
...
Tabs.Quests:Section("Rengoku Sword")
Q = Tabs.Quests:Toggle({
Title = "Auto Get Rengoku Sword", 
...
Tabs.Quests:Section("Cavender + Twin Hooks + Bigmom")
Q = Tabs.Quests:Toggle({
...
Q = Tabs.Quests:Toggle({
Title = "Auto Get Florentino Sword", 
...
Tabs.Quests:Section("Buso / Aura Colours")
Q = Tabs.Quests:Toggle({
...
Tabs.Quests:Section("Instinct / Observation")
Q = Tabs.Quests:Toggle({
...
Bartilo = Tabs.Quests:Toggle({
Title = "Auto Complete Quest Bartilo", 
...
CitizenQ = Tabs.Quests:Toggle({
Title = "Auto Complete Quest Citizen", 
...
Q = Tabs.Quests:Toggle({
Title = "Auto Farm Training Dummy", 
...
Tabs.Quests:Section("Dark Dragger + Valkyrie")
Q = Tabs.Quests:Toggle({
Title = "Auto Farm Rip Indra", 
...
Tabs.Quests:Section("Fighting Melee Styles")
SuperHuman = Tabs.Quests:Toggle({
...
DeathStep = Tabs.Quests:Toggle({
Title = "Auto Get DeathStep", 
...
ElectricClaw = Tabs.Quests:Toggle({
Title = "Auto Get ElectricClaw", 
...
DragonTalon = Tabs.Quests:Toggle({
Title = "Auto Get DragonTalon", 
...
SanguineArt = Tabs.Quests:Toggle({
Title = "Auto Get SanguineArt", 
...
Tabs.Mirage:Section("Mystic Island / Full Moon")
FullMOOn = Tabs.Mirage:Paragraph({
Title = " FullMoon Status ",
Content = ""})
Ismirage = Tabs.Mirage:Paragraph({
...
spawn(function()
  while wait(.2) do
    ...
    -- pcall(function() end) --[[ Ismirage:SetDesc(" Mirage Island : True") ]]
    else
    -- pcall(function() end) --[[ Ismirage:SetDesc(" Mirage Island : False") ]]
    end
  end
end)
spawn(function()
  while wait(.2) do
    pcall(function()
      ...
      moon = Getmoon()
      if moon == moon1 then
    -- pcall(function() end) --[[ FullMOOn:SetDesc("Moon : 0 / 8") ]]
      elseif moon == moon2 then
    -- pcall(function() end) --[[ FullMOOn:SetDesc("Moon : 1 / 8") ]]
      elseif moon == moon3 then
    -- pcall(function() end) --[[ FullMOOn:SetDesc("Moon : 2 / 8") ]]
      elseif moon == moon4 then
    -- pcall(function() end) --[[ FullMOOn:SetDesc("Moon : 3 / 8 [ Next Night ]") ]]
      elseif moon == moon5 then
    -- pcall(function() end) --[[ FullMOOn:SetDesc("Moon : 4 / 8 [ Full Moon ]") ]]
      elseif moon == moon6 then
    -- pcall(function() end) --[[ FullMOOn:SetDesc("Moon : 5 / 8 [ Last Night ]") ]]
      elseif moon == moon7 then
    -- pcall(function() end) --[[ FullMOOn:SetDesc("Moon : 6 / 8") ]]
      elseif moon == moon8 then
    -- pcall(function() end) --[[ FullMOOn:SetDesc("Moon : 7 / 8") ]]
      end
    end)
  end
end)
Q = Tabs.Mirage:Toggle({
...
Q = Tabs.Mirage:Toggle({
Title = "Auto Tween To Advanced Fruit Dealer", 
...
Tabs.Mirage:Section("Skull Guitars / Misc")
CheckSoul = Tabs.Mirage:Paragraph({
Title = "Get Quest Soul Guitar",
Content = ""})
spawn(function()
  while wait(.2) do
    pcall(function()
    -- if Quest1 == true then pcall(function() end) --[[ CheckSoul:SetDesc(" Quest Number : Quest1") ]]
    -- elseif Quest2 == true then pcall(function() end) --[[ CheckSoul:SetDesc(" Quest Number : Quest2") ]]
    -- elseif Quest3 == true then pcall(function() end) --[[ CheckSoul:SetDesc(" Quest Number : Quest3") ]]
    -- elseif Quest4 == true then pcall(function() end) --[[ CheckSoul:SetDesc(" Quest Number : Quest4") ]]
    -- elseif GetWP("Skull Guitar") then pcall(function() end) --[[ CheckSoul:SetDesc(" Quest Number : Collect!!") ]]
    -- else pcall(function() end) --[[ CheckSoul:SetDesc(" Quest Number : No Quest!!") ]]
      end
    end)
  end
end)
...
Q = Tabs.Mirage:Toggle({
Title = "Auto Farm Materials Skull Guitar", 
...
Tabs.Race:Section("Upgrade Races V3")
RaceMink = Tabs.Race:Toggle({
...
RaceSky = Tabs.Race:Toggle({
Title = "Auto Upgrade Angel V3", 
...
RaceFish = Tabs.Race:Toggle({
Title = "Auto Upgrade Fish V3", 
...
Tabs.Race:Section("Trials Quest V4")
CheckTier = Tabs.Race:Paragraph({
Title = "Tier V4",
Content = ""})
spawn(function()
  pcall(function()
    while wait(.2) do
    -- pcall(function() end) --[[ CheckTier:SetDesc(" Tiers - V4  :" .." "..plr.Data.Race.C.Value) ]]
    end
  end)
end)
PullLv = Tabs.Race:Toggle({
...
Tabs.Drago:Section("Dojo Quest & Drago Race")
DojoQ = Tabs.Drago:Toggle({
...
Tabs.Drago:Section("Drago Trial")
...
Toggle = Tabs.Drago:Toggle({
Title = "Auto Relic Draco Trial V4", 
...
dragoTpVolcano = Tabs.Drago:Toggle({
Title = "Tween To Draco Trial V4", 
...
UpTalon = Tabs.Drago:Toggle({
Title = "Upgrade Dragon Talon V3", 
...
Tabs.Prehistoric:Section("Volcanic Magnet")

Toggle = Tabs.Prehistoric:Toggle({
...
Tabs.Prehistoric:Section("Prehistoric Island")
Check_Volcano = Tabs.Prehistoric:Paragraph({
Title = " Prehistoric Island Status",
Content = ""})
spawn(function()
  while wait(.2) do
    if workspace.Map:FindFirstChild("PrehistoricIsland") or workspace._WorldOrigin.Locations:FindFirstChild("Prehistoric Island") then
    -- pcall(function() end) --[[ Check_Volcano:SetDesc(" Prehistoric Island : True") ]]
    else
    -- pcall(function() end) --[[ Check_Volcano:SetDesc(" Prehistoric Island : False") ]]
    end
  end
end)
Vocan = Tabs.Prehistoric:Toggle({
...
Tabs.SeaEvent:Section("Sea Event / Setting Sail")
...
SPYING = Tabs.SeaEvent:Paragraph({
Title = " Spy Status",
Content = ""})
spawn(function()
  while wait(.2) do
    ...
    -- if spycheck then pcall(function() end) --[[ SPYING:SetDesc(" Spy Leviathan  : "..tostring(spycheck) ]])
        if tostring(spycheck) == 5 then
    -- pcall(function() end) --[[ SPYING:SetDesc(" Spy Leviathan : Already Done!!") ]]
        end
      end
    end)
  end
end)
Tabs.SeaEvent:Button({
Title = "Buy Spy", 
Description = "Mua Spy",
CallBack = function()
  replicated:WaitForChild("Remotes"):WaitForChild("CommF_"):InvokeServer("InfoLeviathan","2")
end})
FloD = Tabs.SeaEvent:Paragraph({
...
spawn(function()
  pcall(function()
    ...
    -- pcall(function() end) --[[ FloD:SetDesc(' Flozen Dimension : True') ]]
      else
    -- pcall(function() end) --[[ FloD:SetDesc(' Flozen Dimension : False') ]]
      end
    end
  end)
end)
Q = Tabs.SeaEvent:Toggle({
...
Q = Tabs.SeaEvent:Toggle({
Title = "Auto Sail [Sit Down And Turn On]", 
...
Tabs.SeaEvent:Section("Entity Sea Event")
...
Q = Tabs.SeaEvent:Toggle({
Title = "Auto Attack Fish Crew Member", 
...
Q = Tabs.SeaEvent:Toggle({
Title = "Auto Attack Haunted Crew Member", 
...
Tabs.SeaEvent:Section("Kitsune Island / Event")
Check_Kitsu = Tabs.SeaEvent:Paragraph({
...
spawn(function()
  while wait(.2) do
    ...
    -- pcall(function() end) --[[ Check_Kitsu:SetDesc(" Kitsune Island : True") ]]
    else
    -- pcall(function() end) --[[ Check_Kitsu:SetDesc(" Kitsune Island : False") ]]
    end
  end
end)
Q = Tabs.SeaEvent:Toggle({
...
Tabs.Raids:Section("Fruits Options")

RandomFF = Tabs.Raids:Toggle({
...
Tabs.Raids:Section("Dungeon Event / Raiding")
RaidS = Tabs.Raids:Paragraph({
...
spawn(function()
  while wait(.2) do
    ...
    -- pcall(function() end) --[[ RaidS:SetDesc(" Raiding Status: True") ]]
      else
    -- pcall(function() end) --[[ RaidS:SetDesc(" Raiding Status: False") ]]
      end      
    end)
  end
end)
DungeonTables = {"Flame","Ice","Quake","Light","Dark","String","Rumble","Magma","Human: Buddha","Sand","Bird: Phoenix","Dough"}
Q = Tabs.Raids:Dropdown({
Title = "Select Chip",
Description = "",
...
Q = Tabs.Raids:Toggle({
Title = "Auto Choose Dungeon Chip", 
...
Tabs.Raids:Section("Raiding Menu")
Q = Tabs.Raids:Toggle({
...
Raiding = Tabs.Raids:Toggle({
    Title = "Auto Raid [Safe]",
...
Tabs.Travel:Section("Travel - Worlds")
...
Tabs.Travel:Section("Teleport - Player")
...
Tabs.Shop:Section("Shop Options")
Tabs.Shop:Button({
Title = "Buy Buso", 
...
Tabs.Shop:Section("Fighting - Style")
...
Tabs.Shop:Section("Accessory SeaEvent")
Tabs.Shop:Button({
...
Tabs.Shop:Section("Weapon World 1")
Tabs.Shop:Button({
Title = "Buy Cutlass", 
...
Tabs.Shop:Section("Fragments shop")
Tabs.Shop:Button({
Title = "Refund Stats", 
...
Tabs.Misc:Section("Server - Function")
Tabs.Misc:Button({
Title = "Rejoin Server", 
...
Tabs.Misc:Section("Player Gui / Others")
...
DisbleLeaderB = Tabs.Misc:Toggle({
...
Tabs.Misc:Section("Graphics / Haki Stats")

HakiSt = {"State 0","State 1","State 2","State 3","State 4","State 5"}
HakiStat = Tabs.Misc:Dropdown({
...
Tabs.Misc:Section("Configure - God")
Tabs.Misc:Button({
Title = "Devil Fruit Rain Update 2450", 
